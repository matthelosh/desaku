...
<body>
    <meta charset="UTF-8">
    <link rel="stylesheet" type="text/css" href="/503/503.css">
    <link rel="stylesheet" type="text/css" href="/503/oxygen.fonts.css">
    <div class="container">
        <div class="error">
            <h1>503</h1>
            <h2>error</h2>
            <p>Maaf! Website masih dalam masa perawatan. Silahkan coba lagi lain waktu.</p>
        ...
        <footer>
            <p class="copyright">© Pemerintah Desa Samar - Tulungagung</p>
        </footer>
    </div>
    <style>
        footer {
    ...
    <script type="text/javascript" src="/503/503.js"></script>
</body>
