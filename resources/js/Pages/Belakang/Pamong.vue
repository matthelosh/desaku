...
const getWarga = async() => {
    axios.post(route('dashboard.warga.index'))
...
<DashLayout>
        ...
        <div v-if="mode == 'list'">
            <div class="toolbar w-full border border-sky-200 rounded p-2 bg-sky-100 mb-4 flex justify-between items-center">
                ...
                <div class="toolbar-items flex items-center gap-1">
                    <el-button type="primary" class="flex items-center gap-1" @click="mode = 'form'">
    ...
    <Transition name="pamong">
        <div v-if="mode == 'form'">
            <el-card class="w-full md:w-[60%] mx-auto" v-loading="loading">
                <template #header>
                    <div class="flex items-center justify-between">
                        <h3>Formulir Perangkat Desa</h3>

                        <div class="card-toolbar flex items-center gap-1">
                            <el-button type="primary" size="small" @click="simpan">
                                Simpan
                            </el-button>
                            <el-button type="danger" circle size="small" @click="mode = 'list'">
                                <Icon icon="mdi:close" />
                            </el-button>
                        </div>
                    </div>
                                    ...
                                    <el-row :gutter="20">
                                        ...
                                        <el-col :span="16">
                                            <el-descriptions :border="true" :column="2">
                                                ...
                                                <el-descriptions-item label="Agama">{{ selectedWarga.agama }}</el-descriptions-item>
                                                <el-descriptions-item label="Tempat, Tanggal Lahir">{{ selectedWarga.tempat_lahir }}, {{ dayjs(selectedWarga.tanggal_lahir ).format('DD-MM-YYYY')}}</el-descriptions-item>
                                            </el-descriptions>
                                        </el-col>
                                    </el-row>
                                </el-card>
