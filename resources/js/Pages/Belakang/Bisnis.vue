    ...
    <div class="relative">
        <div class="toolbar w-full border border-sky-200 rounded p-2 bg-sky-100 mb-4 flex justify-between items-center">
            <h3 class=" text-sky-800 text-xl flex gap-1 items-center">
                ...
                Data Bisnis dan Usaha di Desa Samar
            </h3>
        ...
        <TransitionGroup name="pos" >
            <el-table :data="businesses" height="85vh" v-if="mode === 'list'" style="width: 100%;">
                ...
                <el-table-column label="Skala" prop="skala" width="100"></el-table-column>
