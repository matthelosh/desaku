                ...
                <el-row justify="center" class="w-full">
                    <el-col :span="16" :xs="24">
                            ...
                            <el-col class="bg-sky-200 h-10 p-2">
                                ...
                                >
                                    ...
                                    <el-breadcrumb-item
                                        :to="{ path: '/profil' }"
                                    >
                                        <template #default> Profil </template>
                                    </el-breadcrumb-item>
                                </el-breadcrumb>
                            </el-col>
                        </el-row>
                        <el-row class="w-full">
                            <el-col>
                                <div
                                    class="grid md:grid-cols-3 gap-4 px-4 md:px-0"
                                    v-if="posts.length > 0"
                                >
                                    <div
                                        v-for="(post, p) in posts"
                                        :key="p"
                                        class="card bg-white col-span-1 rounded-md overflow-hidden shadow"
                                    >
                                        <div class="card-header p-4">
                                            <h3 class="font-bold text-2xl">
                                                <Link
                                                    :href="`/profil/${post.category_id}`"
                                                >
                                                    {{ post.title }}
                                                </Link>
                                            </h3>
                                            <div
                                                class="meta w-full my-2 flex gap-2"
                                            >
                                                <el-tag type="primary">{{
                                                    post.category_id
                                                }}</el-tag>
